!function (e, t) {
  ...
  return function (e) {
    ...
    var h = i(1), d = o(h), f = i(2), y = (o(f), i(3)), v = o(y), m = i(4), g = o(m), b = i(5), _ = g.MSG,
    ...
    var i = window.navigator.userAgent, o = /AppleWebKit\/([\d.]+)/i.exec(i), n = o ? parseFloat(o.pop()) : null,
      r = t.IS_IPAD = /iPad/i.test(i), s = t.IS_IPHONE = /iPhone/i.test(i) && !r, l = t.IS_IPOD = /iPod/i.test(i),
      a = t.IS_IOS = s || r || l, c = (t.IOS_VERSION = function () {
    ...
    function p(e) {
      ...
      var i = document.documentElement, o = document.body, n = i.clientLeft || o.clientLeft || 0,
        r = window.pageXOffset || o.scrollLeft, s = t.left + r - n, l = i.clientTop || o.clientTop || 0,
        a = window.pageYOffset || o.scrollTop, c = t.top + a - l;
      return {left: Math.round(s), top: Math.round(c)}
    }

    function h(e, t, i) {
      var o = {}, n = i || p(e), r = e.offsetWidth, s = e.offsetHeight, l = n.top, a = n.left, c = t.pageY || t.clientY,
        u = t.pageX || t.clientX;
    ...
    var s = i(1), l = n(s), a = i(2), c = n(a), u = i(3), p = n(u), h = i(4), d = n(h), f = i(10), y = o(f), v = i(13),
      m = o(v), g = i(14), b = o(g), _ = i(22), w = o(_), S = i(23), E = o(S), M = i(24), O = o(M), k = i(25), P = o(k);
    ...
    var I = t.MSG = d.MSG, T = t.browser = l, C = t.util = p, x = t.dom = c;
    t.Player = function () {
      function e(t) {
      ...
      return e.prototype.render = function (e) {
        ...
        return T.IE_VERSION && C.compareVersion(T.IE_VERSION, "8.0") == -1 ? (this.errortips.show({code: 5}), !1) : T.IS_FILE_PROTOCOL ? (this.errortips.show({code: 10}), !1) : !!this.options.src || (this.options.videoSource.hasUrl() ? T.IS_IE || !T.IS_ENABLED_FLASH ? this.errortips.show({code: 5}) : this.errortips.show({code: 5}) : this.errortips.show({code: 12}), !1)
    ...
    function n(e) {
      for (var t = [], i = {}, o = 0; o < e.length; o++) {
        var n = e[o], r = n[0], s = n[1], l = n[2], a = n[3], c = {css: s, media: l, sourceMap: a};
    ...
    function r(e, t) {
      var i = v(), o = b[b.length - 1];
      if ("top" === e.insertAt) o ? o.nextSibling ? i.insertBefore(t, o.nextSibling) : i.appendChild(t) : i.insertBefore(t, i.firstChild), b.push(t); else {
    ...
    var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
      ...
      }, c = i(11), u = n(c), p = i(2), h = o(p), d = i(3), f = o(d), y = i(4), v = i(12), m = o(v), g = i(1), b = o(g),
      _ = (f.FullscreenApi, {
        "0.7.1": "libs/hls.js",
        ...
        return l(t, e), t.prototype.render = function (t) {
          ...
          if (!b.IS_ENABLED_MSE || !i && !o || b.IS_X5TBS && this.player.options.x5_player || i && b.IS_MAC && b.IS_SAFARI && !b.IS_IOS) this.__type = t, this.el.src = e; else {
    ...
    t.__esModule = !0;
    var l = i(2), a = o(l), c = i(3), u = o(c), p = i(4), h = o(p), d = i(1), f = o(d), y = function () {
      function e(t, i) {
      ...
      return e.prototype.createEl = function (e, t, i) {
        ...
        var o = s(this.guid, i), n = !o, l = o && !this.fnCache[o];
    ...
    t.__esModule = !0;
    var c = i(11), u = n(c), p = i(4), h = i(2), d = o(h), f = i(3), y = o(f), v = i(12), m = o(v), g = i(1), b = o(g),
      _ = function (e) {
        function t(i) {
          r(this, t);
        ...
        return l(t, e), t.prototype.render = function (e) {
          ...
          try {
            switch (this.options.debug && this.pub({
              ...
              case"netStatus":
                this.options.live || ("NetStream.Buffer.Full" == t.code ? (this.__prevPlayState == m.PlayStates.PAUSED || this.__prevPlayState == m.PlayStates.STOP, this.__prevPlayState = null) : "NetStream.Seek.Complete" == t.code), "NetConnection.Connect.Closed" == t.code && this.options.src.indexOf("rtmp://") > -1 && (this.playState == m.PlayStates.STOP ? (i.type = "error", t = {
                  code: 13,
                  reason: t.code
                }) : (i.type = "error", t = {code: 1002, reason: t.code})), "NetStream.Play.Stop" == t.code;
                break;
              case"mediaTime":
            ...
            !l && this.pub({type: i.type, src: this, ts: i.ts, detail: t})
          } catch (c) {
    ...
    t.__esModule = !0;
    var a = i(11), c = n(a), u = i(15), p = n(u), h = i(16), d = n(h), f = i(17), y = i(18), v = n(y), m = i(19),
      g = n(m), b = i(20), _ = n(b), w = i(21), S = n(w), E = i(4), M = i(2), O = o(M), k = i(3), P = o(k), I = i(1),
      T = o(I), C = function (e) {
        function t(i) {
    ...
    t.__esModule = !0;
    var a = i(11), c = n(a), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = (o(h), i(12)), f = (o(d), function (e) {
      function t(i) {
    ...
    t.__esModule = !0;
    var a = i(11), c = n(a), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = o(h), f = function (e) {
      function t(i) {
    ...
    var a = i(11), c = n(a), u = i(2), p = o(u), h = i(4), d = (o(h), i(3)),
    ...
    t.__esModule = !0;
    var a = i(17), c = n(a), u = i(11), p = n(u), h = i(2), d = (o(h), i(3)), f = o(d), y = function (e) {
      function t(i) {
    ...
    t.__esModule = !0;
    var a = i(17), c = (n(a), i(11)), u = n(c), p = i(2), h = (o(p), i(3)), d = o(h), f = function (e) {
      function t(i) {
    ...
    t.__esModule = !0;
    var a = i(17), c = n(a), u = i(11), p = n(u), h = i(2), d = o(h), f = i(3), y = o(f), v = i(4), m = function (e) {
      function t(i) {
    ...
    t.__esModule = !0;
    var a = i(11), c = n(a), u = i(2), p = o(u), h = i(3), d = o(h), f = {od: "超清", hd: "高清", sd: "标清"},
      y = function (e) {
        function t(i) {
          r(this, t);
    ...
    t.__esModule = !0;
    var a = i(11), c = n(a), u = i(1), p = o(u), h = function (e) {
      function t(i) {
    ...
    var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
      ...
      return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
    }, c = i(11), u = n(c), p = i(2), h = o(p), d = i(3), f = o(d), y = i(1), v = o(y), m = i(4), g = function (e) {
      function t(i) {
        r(this, t);
        var o = s(this, e.call(this, i, "Poster"));
        return o.options.poster && "object" == a(o.options.poster) ? o.poster = o.options.poster : "string" == typeof o.options.poster ? o.poster = {src: o.options.poster} : o.poster = {}, o
      }
    ...
    t.__esModule = !0;
    var a = i(11), c = n(a), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = (o(h), {});
    !function (e, t) {
      e.Spinner = t()
    }(d, function () {
      function e(e, t) {
      ...
      function i(e, t, i, o) {
        var n = ["opacity", t, ~~(100 * e), i, o].join("-"), r = .01 + i / o * 100,
          s = Math.max(1 - (1 - e) / t * (100 - r), e), l = c.substring(0, c.indexOf("Animation")).toLowerCase(),
          a = l && "-" + l + "-" || "";
        ...
        u.addRule(".spin-vml", "behavior:url(#default#VML)"), l.prototype.lines = function (e, o) {
          ...
          function l(e, l, a) {
            t(h, t(n(r(), {
              ...
              left: ~~l
            }), t(n(i("roundrect", {arcsize: o.corners}), {
              width: c,
              height: o.scale * o.width,
              left: o.scale * o.radius,
              top: -o.scale * o.width >> 1,
              filter: a
            }), i("fill", {color: s(o.color, e), opacity: o.opacity}), i("stroke", {opacity: 0}))))
          }

          var a, c = o.scale * (o.length + o.width), u = 2 * o.scale * c,
            p = -(o.width + o.length) * o.scale * 2 + "px", h = n(r(), {position: "absolute", top: p, left: p});
      ...
      if (l.defaults = {}, r(l.prototype, {
        spin: function (t) {
          this.stop();
          var i = this, o = i.opts, r = i.el = e(null, {className: o.className});
          if (n(r, {
            position: o.position,
            width: 0,
            zIndex: o.zIndex,
            ...
            var s, l = 0, a = (o.lines - 1) * (1 - o.direction) / 2, u = o.fps, p = u / o.speed,
              h = (1 - o.opacity) / (p * o.trail / 100), d = p / o.lines;
            !function f() {
              l++;
          ...
          }), r.shadow && t(a, n(l("#000", "0 0 4px #000"), {top: "2px"})), t(o, t(a, l(s(r.color, u), "0 0 1px rgba(0,0,0,.1)")));
          return o
    ...
    t.__esModule = !0;
    var a = i(11), c = n(a), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = o(h), f = {
